...
$kysely = $yhteys->prepare("UPDATE toimitukset SET tila = 'Aloitettu', piilotettu = 0 WHERE id = ?");
$kysely->execute(array($_GET["id"]));

echo "<p>Tilauksen tilaksi on palautettu aloitetuksi ja tilaus on siirretty takaisin toimituksiin!</p>";
echo "<p><a href=\"aiemmat.php\" class=\"btn btn-info\">Takaisin</a></p>";
?>
    </div>
